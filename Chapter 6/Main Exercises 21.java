...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int divisor = 0, number = 0; //divisor 100000 - work good

        System.out.print(" Enter a five digit number:");
        number = input.nextInt();
        System.out.print(" Introduce divisorul: ");
    ...
    public static void AP(int number, int divisor) {

        if (number >= 1 && number <= 99999) {
            System.out.print("");

            displayDigits(number, divisor);
        } else {
    ...
    // Part C
    public static void displayDigits(int number, int divisor) {
        int digit, x = 5, y = 80;
        String s = "";
